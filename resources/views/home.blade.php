...
<body>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                @if (auth()->check())
                    ...
                    @if (auth()->user()->permissaoID == 1)
                        <li class="nav-item">
                            <a class="btn btn-success m-1" href="{{ route('Produtos.create') }}">Criar produto</a>
                        </li>
                        <li class="nav-item">
                    ...
                    @else
                        <li class="nav-item">
                            ...
                            <a type="button" class="btn btn-success m-1" href="{{ route('carrinho.index') }}"><i
                                    class="fa-solid fa-cart-shopping ms-3" style="color: #000000;"></i>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        ...
                        <li class="list-group-item" style="background-color: black">R$: {{ $produto->precoUnitario }}
                        </li>
                        @if (auth()->check())
                            @if (auth()->user()->permissaoID == 1)
                                <div class="row">
                                    <div class="col-2">
                                        <a href="{{ route('Produtos.edit', $produto->id) }}" class="btn btn-success"><i
    ...
    <button class="carousel-control-prev" type="button" data-bs-target="#carousel-{{ $produto->id }}"
        data-bs-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="visually-hidden">Previous</span>
    </button>
    <button class="carousel-control-next" type="button" data-bs-target="#carousel-{{ $produto->id }}"
        data-bs-slide="next">
